...
import com.dyy.alipay.utils.httpClient.HttpProtocolHandler;
import com.dyy.alipay.utils.httpClient.HttpRequest;
import com.dyy.alipay.utils.httpClient.HttpResponse;
import com.dyy.alipay.utils.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static Map<String, String> buildRequestPara(
			Map<String, String> sParaTemp, String payKey) {
		// 除去数组中的空值和签名参数
	...
	public static String buildRequest(String ALIPAY_GATEWAY_NEW,
			...
			Map<String, String> sParaTemp, String payKey) throws Exception {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp, payKey);
	...
	public static String getRequestToken(String text) throws Exception {
		...
		if (paraText.get("res_data") != null) {
	        ...
	        Element eName = root.element("request_token");  
	   		request_token = eName.getTextTrim();
		}
	...
	public static final String ALIPAY_WAP_GATEWAY = "http://wappaygw.alipay.com/service/rest.htm?";// wap版支付网关
	...
	public static String buildRequest(Map<String, String> sParaTemp,
			String strMethod, String strButtonName, String payKey) {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp, payKey);
	...
	public static String buildWapRequest(Map<String, String> sParaTemp,
			String strMethod, String strButtonName, String payKey) {
		// 待请求参数数组
		Map<String, String> sPara = buildWapRequestPara(sParaTemp, payKey);
		List<String> keys = new ArrayList<String>(sPara.keySet());
     ...
     * @throws Exception
     */
    public static String buildWapRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,Map<String, String> sParaTemp,String parKey) throws Exception {
        //待请求参数数组
        Map<String, String> sPara = buildWapRequestPara(sParaTemp,parKey);
     ...
     * @return 要请求的参数数组
     */
    public static Map<String, String> buildWapRequestPara(Map<String, String> sParaTemp,String parKey) {
        //除去数组中的空值和签名参数
        Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);
        //生成签名结果
        String mysign = buildWapRequestMysign(sPara,parKey);
     ...
     * @return 签名结果字符串
     */
	public static String buildWapRequestMysign(Map<String, String> sPara,String parKey) {
    	String prestr = AlipayCore.createLinkString(sPara); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
    	String mysign = "";
        if(AlipayConfig.sign_type.equals("MD5") ) {
        	mysign = MD5.sign(prestr, parKey, AlipayConfig.input_charset);
